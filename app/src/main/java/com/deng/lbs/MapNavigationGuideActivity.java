 ...
 */
public class MapNavigationGuideActivity extends AppCompatActivity{

    private final String TAG = MapNavigationGuideActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(MapNavigationMainActivity.ROUTE_PLAN_NODE);
    ...
    private void addCustomizedLayerItems() {
        ...
        if (mBNRoutePlanNode != null) {
            item1 = new BNRouteGuideManager.CustomizedLayerItem(mBNRoutePlanNode.getLongitude(), mBNRoutePlanNode.getLatitude(),
                    ...
                    BNRouteGuideManager.CustomizedLayerItem.ALIGN_TOP);
            items.add(item1);
